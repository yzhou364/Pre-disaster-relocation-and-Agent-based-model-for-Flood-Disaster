...
def sim(subsidy,goverDis,midResDis,lowResDis,midProperty,additionalMoveCost,housePriceCutoffPer,numofType,distanceThres,vacancy,decisionProb):
    calLength = 80
    resFile = open(r"C:\Users\yzhou364\Desktop\Dissertation\Experiment results\Res\Neighbor\resident_objects_zipclass_{additionalMoveCost}.dat".format(
        additionalMoveCost =additionalMoveCost),"rb")
...
#csvwriter.writerow(["Param","Objective","Number of free rider1","Number of free rider2","Total movement"])
            runningIndex = 0
            minObj = 10000000000
            f2 = open(r"C:\Users\yzhou364\Desktop\Dissertation\Experiment results\Res\Neighbor\result\exp_resident_objects_zipSimi_{additionalMoveCost}_{vacancy}_{dp}.csv".format(
                additionalMoveCost =k,vacancy=m,dp=n),"w", newline='')
            csvwriter = csv.writer(f2)
            ...
            for j in subsidyRange:
                ...
                result = sim(subsidy=j,goverDis = 0.025,midResDis=0.12, 
                                           ...
                                           numofType=15,distanceThres=0,vacancy=m,decisionProb=n)
