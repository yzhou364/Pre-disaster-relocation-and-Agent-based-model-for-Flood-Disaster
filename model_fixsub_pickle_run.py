...
for i in govDisRateRange:
    ...
    runningIndex = 0
    f2 = open(r"C:\Users\yzhou364\Desktop\Dissertation\Experiment results\NY_Res\5.7\govDisExp_{ntype}_750K_15types.csv".format(ntype=i),"w", newline='')
    csvwriter = csv.writer(f2)
