...
housepriceCutoff = np.linspace(0,2000000,21)
optimalSum = []
...
for j in housepriceCutoff:
    ...
    runningIndex = 0
    minObj = 10000000000
    f2 = open(r"C:\Users\yzhou364\Desktop\Dissertation\Experiment results\Res\tx\houseCutOff_{ntype}_300K_15types.csv".format(ntype=j),"w", newline='')
    csvwriter = csv.writer(f2)
    csvwriter.writerow(["Param","Objective","Number of free rider1","Number of free rider2","Total movement"])
...
with open(r"C:\Users\yzhou364\Desktop\Dissertation\Experiment results\Res\tx\sum\300KhouSummary.csv","w",newline='') as f:
    writer = csv.writer(f)
