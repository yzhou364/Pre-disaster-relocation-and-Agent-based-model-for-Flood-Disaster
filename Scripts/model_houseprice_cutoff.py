...
elevationCutoff  =np.linspace(0,2,21)
housepriceCutoff = np.linspace(0,2500000,26)
...
for j in housepriceCutoff:
    ...
    runningIndex = 0
    f2 = open(r"C:\Users\yzhou364\Desktop\Dissertation\Experiment results\NY_Res\6.28\houseCutOff_{ntype}_750K_15types.csv".format(ntype=j),"w", newline='')
    csvwriter = csv.writer(f2)
    csvwriter.writerow(["Param","Objective","Number of free rider1","Number of free rider2","Total movement"])
