...
ax.set_xlim(0,90)
#ax.set_title("Number of moving residents sensitivity of 300K base case")
...
fmt = '${x:,.0f}'
ax.yaxis.set_ticks(np.arange(0,300000,50000))
tick = mtick.StrMethodFormatter(fmt)
ax.yaxis.set_major_formatter(tick) 
ax.legend(["Optimal subsidy"], bbox_to_anchor=(1.0, 0.2))
ax.set_title("Optimal subsidy sensitivity of 300K base case")
...
fmt = '${x:,.0f}'
ax.yaxis.set_ticks(np.arange(0,550000000,50000000))
tick = mtick.StrMethodFormatter(fmt)
ax.yaxis.set_major_formatter(tick) 
ax.legend(["Objective value"], bbox_to_anchor=(1.0, 0.2))
ax.set_title("Objective value sensitivity of 300K base case")
...
ax.set_ylabel("Optimal subsidy ($)")
fmt = '${x:,.0f}'
ax.yaxis.set_ticks(np.arange(0,700000,50000))
tick = mtick.StrMethodFormatter(fmt)
ax.yaxis.set_major_formatter(tick) 
ax.set_title("Optimal subsidy sensitivity")
