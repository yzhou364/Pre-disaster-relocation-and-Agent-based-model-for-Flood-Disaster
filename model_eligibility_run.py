...
def sim(subsidy=10000,goverDis = 0.025,midResDis=0.12, lowResDis=0.18,midProperty=50000,
       additionalMoveCost = 300000,housePriceCutoffPer=50,cutoff=1000000):
...
#subsidyRange = np.linspace(1000,100000,100)
...
cutoff = np.linspace(500000,1500000,5)



f1 = open(r"C:\Users\yzhou364\Desktop\Dissertation\Experiment results\NY_Res\subsidy_cutoff_test_03.csv","w", newline='') 
...
for i in runningParam:
    runningIndex +=1
    csvwriter.writerow([i]+sim(subsidy=20000,goverDis = 0.025,midResDis=0.12, 
                               lowResDis=0.18,midProperty=50000,
                               additionalMoveCost = 300000,housePriceCutoffPer=50,cutoff=i))
